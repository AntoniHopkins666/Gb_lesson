...
public class HomeWorkApp {
    public static void main(String[] args) {
        ...
        System.out.println (metod2 (0)); // 2. Написать метод, которому в качестве параметра передается целое число, метод должен напечатать в консоль, положительное ли число передали или отрицательное. Замечание: ноль считаем положительным числом.
    ...
    static String metod2 (int a){
        return ("Число " + (a < 0? "отрицательное" : "положительное"));
    }
